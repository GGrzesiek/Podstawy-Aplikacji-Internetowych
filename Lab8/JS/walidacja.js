...
function sprawdz_radio(radio_tapok) {
...
function sprawdz_box(input_type) {
    inputs = [];
...
function sprawdz() {
    ...
    nazw = sprawdzPole('nazw', obiektNazw);
    wiek = sprawdzPole('wiek', obiektWiek);
    email = sprawdzPole('email', obiektemail);
    kraj = document.getElementById('kraj').value;
    jezyki = sprawdz_box('jezyk');
    oplata = sprawdz_radio('zaplata');
